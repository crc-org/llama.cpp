...
typedef enum ApirBackendCommandType {
  ...
  APIR_COMMAND_TYPE_BUFFER_TYPE_GET_ALLOC_SIZE = 14,

  /* buffer */
  APIR_COMMAND_TYPE_BUFFER_GET_BASE = 15,
  APIR_COMMAND_TYPE_BUFFER_SET_TENSOR = 16,
  APIR_COMMAND_TYPE_BUFFER_GET_TENSOR = 17,
  APIR_COMMAND_TYPE_BUFFER_CPY_TENSOR = 18,
  APIR_COMMAND_TYPE_BUFFER_CLEAR = 19,
  APIR_COMMAND_TYPE_BUFFER_FREE_BUFFER = 20,

  /* backend */
  APIR_COMMAND_TYPE_BACKEND_GRAPH_COMPUTE = 21,

  /* metal */
  APIR_COMMAND_TYPE_METAL_GET_DEVICE_CONTEXT = 22,
