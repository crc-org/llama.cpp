...
/* backend */
uintptr_t   apir_backend_initialize(struct virtgpu * gpu, void * ggml_backend_reg_fct_p, uint32_t* out_result);
ggml_status apir_backend_graph_compute(struct virtgpu * gpu, uintptr_t backend_handle, ggml_cgraph * cgraph);
void        apir_backend_cleanup(struct virtgpu * gpu, uintptr_t backend_handle);
